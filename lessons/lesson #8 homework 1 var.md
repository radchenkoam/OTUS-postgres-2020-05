...
***
<div align="center"><h4>Журналы и контрольные точки</h2></div>
...
<div align="center"><h4>Сравнение tps в синхронном/асинхронном режиме утилитой pgbench</h2></div>
...
<div align="center"><h4>Кластер с включенной контрольной суммой страниц </h2></div>

🔗 [data-checksums](https://postgrespro.ru/docs/postgresql/11/app-initdb "Ctrl+click -> new tab")
